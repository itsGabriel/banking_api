defmodule BankingApiWeb.SessionControllerTest do
  ...
  describe "session" do
    ...
    test "create an user with invalid data renders error changeset", %{conn: conn} do
    ...
    test "create an user with existing email renders changeset error", %{conn: conn} do
